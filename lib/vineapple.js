 ...
 */
var
    pkginfo = require('pkginfo'),   // https://github.com/indexzero/node-pkginfo
    _       = require('lodash'),    // https://github.com/bestiejs/lodash
    util    = require('util'),      // http://nodejs.org/api/util.html
    crypto  = require('crypto'),    // http://nodejs.org/api/crypto.html
 ...
 * @param settings.userId {String}
 * @param settings.username {String}
...
Vineapple.prototype = {
    ...
    request: function (options, callback) {
        ...
        options = _.merge({},this.request_options,options);
    ...
    login: function (username, password, callback) {
        ...
        // Primitively validate username and password
        if (!username) {
    ...
    authorize: function (settings) {
        ...
        this.request_options = (settings && settings.request_options) || {};
        return this;
    },
     ...
     * @param options.page  {Number}   1
     * @param options.size  {Number}   20
     * @param callback      {Function} [optional]
     * @return {Object} request API promise
     */
